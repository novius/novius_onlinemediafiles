define(
    ...
    function($) {
        ...
        return function($btn_synchro, onme_id, form_id) {
            ...
            {
                $left_col.add($right_col).css('visibility', 'visible');
...
//                }
                ...
                if (metadatas.length) {
                    try {
                        ...
                        if (metadatas) {
                            $description.closest('tr').after('<tr class="row_metadatas"><th><label>Informations additionnelles</label></th><td><div class="wrap_metadatas"></div></td></tr>');
            ...
            {
                $left_col.add($right_col).css('visibility', 'hidden');
            }
